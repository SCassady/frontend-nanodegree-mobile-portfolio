...
changeSliderLabel(size);function changePizzaSizes(size){switch(size){case"1":var newWidth=25;break;case"2":var newWidth=33;break;case"3":var newWidth=50;break;default:console.log("bug in sizeSwitcher");}
var randomPizzas=document.querySelectorAll(".randomPizzaContainer");for(var i=0;i<randomPizzas.length;i++){randomPizzas[i].style.width=newWidth+"%";}}
...
function updatePositions(){frame++;window.performance.mark("mark_start_frame");var items=document.querySelectorAll('.mover');var scrollAmount=document.body.scrollTop/1250;for(var i=0;i<items.length;i++){var phase=Math.sin(scrollAmount+(i%5));items[i].style.left=items[i].basicLeft+100*phase+'px';}
